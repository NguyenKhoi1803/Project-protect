    ...
    <div className="footer">
      <div className="footer__info">
        <div className="footer__info--details">
          ...
          <p>
            The idea is to combine the motorbike phenomenon of the city with the
            beauty of Vietnamese women in our traditional outfit to
        ...
        <div className="footer__info--details">
          ...
          <p>
            ...
            culture, we provide some tips & information to help you know the ins
            and outs of travel in Vietnam
          </p>
          <ul>
